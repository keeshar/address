    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String city = contactDetailsPanel.geteMailField().getText(); 
            String age = contactDetailsPanel.geteMailField().getText(); 
            String dob = contactDetailsPanel.geteMailField().getText(); 
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email, city,age,dob);
